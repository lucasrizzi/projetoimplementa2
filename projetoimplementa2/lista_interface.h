 ...
 * Retorna 1 caso conseguir inserir, 0 caso contrario
 * Pre: A lista e o novo elemento a ser inserido devem ser validos
 * Pos: O elemento recebido como parametro eh inserido na posicao especificada em "posicao" ou na cabeca da lista ou na cauda da lista. Retorna 1 caso conseguir inserir, 0 caso contrario
 */
